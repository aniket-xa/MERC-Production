...
Status:-Pending</h4>
     ...
     <s:if test="PetitiFileMovment.level!= null and #session.CERC_USER.refOrganisationId.id == 1 and #session.CERC_USER.userType == 'E' and cercPetition.refStatusId.id !=12 and(PetitiFileMovment.level==1 or #session.CERC_USER.id == PetitiFileMovment.cercUserId)">
