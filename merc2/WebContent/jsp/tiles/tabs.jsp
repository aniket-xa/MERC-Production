...
<div id="tab-container" class='tab-container' style="padding-top: 6pt" >
	<s:if		test="#session.CERC_USER.userType == 'I' or #session.CERC_USER.userType == 'O' or (#session.CERC_USER.refOrganisationId.id == 1 and #session.CERC_USER.userType != 'E') or (#session.CERC_USER.refOrganisationId.id != 1 and #session.CERC_USER.userType == 'E') or (#session.CERC_USER.refDivisionId.divisionCode.trim()=='8' or #session.CERC_USER.refDivisionId.divisionCode.trim()=='12')">
	<ul class='etabs'>
   		<s:if test="filingBeanId!=null">
   			...
   			<s:if test="(#session.CERC_USER.userType=='E' and #session.CERC_USER.refOrganisationId.id==1 and (#session.CERC_USER.refDivisionId.divisionCode.trim()=='8' or #session.CERC_USER.refDivisionId.divisionCode.trim()=='12')) or (#session.CERC_USER.userType=='E' and #session.CERC_USER.refOrganisationId.id!=1 and #session.CERC_USER.refDivisionId==null) or #session.CERC_USER.userType=='O'">
	   			<s:if test = "filingBean.diaryNumber!=null">
...
<%-- 		   		</s:else> --%>
	   	...
	   	<s:if test = "#session.CERC_USER.userType!='I' and #session.CERC_USER.userType!='A'">
	   	...
	   	<s:if test = "#session.CERC_USER.refOrganisationId.id!=1 and #session.CERC_USER.userType!='E'">
   			...
   			<s:if test="#session.ACTIVE_TAB=='Attachments'">
	   				<li class='tab' style="background-color: #000000;">
	   					<s:a action="filingDocumentDetailsList">
							...
							<s:param name="token" value="token"/>
							<s:param name="filingBeanId" value="filingBeanId"/>
	   						<font style="color:#B2904A;font-weight: bolder;" >Attachments <span class="required">*</span></font>
	   					</s:a>
	   				</li>
	   			</s:if>
	   			<s:else>
   				...
   				<s:a action="filingFeeDetails">
					...
					<s:param name="token" value="token"/>
					<s:param name="filingBeanId" value="filingBeanId"/>
   				<font style="color:#B2904A;font-weight: bolder;" >Filing Fees<span class="required">*</span></font></s:a></li>
   			</s:if>
   			<s:else>
   				...
   				<s:param name="struts.token.name" value="%{'token'}"/>
					<s:param name="token" value="token"/>
					<s:param name="filingBeanId" value="filingBeanId"/>
   				Filing Fees<span class="required">*</span></s:a></li>
   			</s:else>
	   			</s:if>
	   			</s:if>
   		<s:if test="filingBeanId!=null">
<%--    			<s:if test="filingBean.diaryNumber==null"> --%>
<s:if test="filingBean.diaryNumber==null or (#session.CERC_USER.userType == 'O' and #session.CERC_USER.refOrganisationId.id!=1 and ((filingBean.diaryNumber!=null and cercPetition.registrationNumber==null) or (filingBean.diaryNumber!=null and cercPetition.refStatusId.id==12) or (filingBean.diaryNumber!=null and (cercPetition.refStatusId.id==54 or cercPetition.refStatusId.id==55))))">   		
<!--    			24-04-2020 start SH following the srs -->
   			<s:if test="filingBean.refPetitionType.petitionTypeCode!='SM'">
<%--    			<s:if test="filingBean.refPetitionType.petitionTypeCode=='SM'"> --%>
<!--    			24-04-2020 start end following the srs -->
...
<%--    			<s:if test="(cercPetition!=null and (cercPetition.refPetitionSubtypeId==null or (cercPetition.refPetitionSubtypeId.petitionSubTypeCode!=3 and cercPetition.refPetitionSubtypeId.petitionSubTypeCode!=8))) or filingBean.refPetitionSubType==null or (filingBean.refPetitionSubType.petitionSubTypeCode!=3 and filingBean.refPetitionSubType.petitionSubTypeCode!=8)"> --%>
   		...
   		<s:if test="(#session.CERC_USER.userType == 'O' and #session.CERC_USER.refOrganisationId.id!=1 and ((filingBean.diaryNumber!=null and cercPetition.registrationNumber==null) or (filingBean.diaryNumber!=null and cercPetition.refStatusId.id==12) or (filingBean.diaryNumber!=null and (cercPetition.refStatusId.id==54 or cercPetition.refStatusId.id==55))))">
   			<s:if test="#session.ACTIVE_TAB=='Fees'">
   				<li class='tab' style="background-color: #000000;">
   				<s:a action="filingFeeDetails">
   					<s:param name="struts.token.name" value="%{'token'}"/>
...
<%--    			</s:if> --%>
   			...
   			<s:if test="filingBean.diaryNumber!=null">	
   				...
   				<s:if test="(#session.CERC_USER.userType == 'I' or #session.CERC_USER.userType == 'E' or #session.CERC_USER.userType == 'A' or #session.CERC_USER.userType == 'O') and ((filingBean.diaryNumber!=null and cercPetition.registrationNumber==null) or (filingBean.diaryNumber!=null and cercPetition.refStatusId.id==12) or (filingBean.diaryNumber!=null and (cercPetition.refStatusId.id==54 or cercPetition.refStatusId.id==55)))">
   				<s:if test="filingBean.registrationNumber!=null">
...
<%--    			<s:if test="filingBean.diaryNumber==null or (#session.CERC_USER.userType == 'O' and #session.CERC_USER.refOrganisationId.id!=1 and ((filingBean.diaryNumber!=null and cercPetition.registrationNumber==null) or (filingBean.diaryNumber!=null and cercPetition.refStatusId.id==12) or (filingBean.diaryNumber!=null and (cercPetition.refStatusId.id==54 or cercPetition.refStatusId.id==55))))">	 --%>
   			<s:if test="#session.ACTIVE_TAB=='Check List'">		
   				...
   				<s:a action="filingCheckList">
					...
					<s:param name="token" value="token"/>
					<s:param name="filingBeanId" value="filingBeanId"/>
   				<font style="color:#B2904A;font-weight: bolder;" >Check List<span class="required">*</span></font></s:a></li>
   			</s:if>
   			<s:else>
   				<li class='tab'>
   				<s:a action="filingCheckList">
					...
					<s:param name="token" value="token"/>
					<s:param name="filingBeanId" value="filingBeanId"/>
   				Check List<span class="required">*</span></s:a></li>
   			</s:else>
   			</s:if>
   			</s:if>
   			
   			<s:elseif test="(#session.CERC_USER.userType == 'O' and #session.CERC_USER.refOrganisationId.id!=1 and ((filingBean.diaryNumber!=null and cercPetition.registrationNumber==null) or (filingBean.diaryNumber!=null and cercPetition.refStatusId.id==12) or (filingBean.diaryNumber!=null and (cercPetition.refStatusId.id==54 or cercPetition.refStatusId.id==55))))">
   			...
   			<s:if test = "#session.CERC_USER.userType=='I' or #session.CERC_USER.userType=='A' or #session.CERC_USER.refOrganisationId.id==1 or #session.CERC_USER.userType=='E'">
...
<!-- 							13-04-2020 end SH -->
   			...
   			<s:if test = "#session.CERC_USER.userType=='I' or #session.CERC_USER.userType=='A'">
			...
			<s:if test="#session.ACTIVE_TAB=='General Information'">
   				<li class='tab' style="background-color: #000000;">
   					<s:a action="filingGeneralInformation">
						...
						<s:param name="token" value="token"/>
						<s:param name="filingBeanId" value="filingBeanId"/>
   						<font style="color:#B2904A;font-weight: bolder;" >General Information<span class="required">*</span></font>
   					</s:a>
   				</li>
   			</s:if>
   			<s:else>
   				<li class='tab'>
	   				<s:a action="filingGeneralInformation">
						...
						<s:param name="token" value="token"/>
						<s:param name="filingBeanId" value="filingBeanId"/>
	   					General Information<span class="required">*</span>
	   				</s:a>
   				</li>
   			</s:else>
