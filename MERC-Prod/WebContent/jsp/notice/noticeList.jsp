...
<s:form theme="simple" name="noticeList">
			...
			<td colspan="7">
				<table border = "0" >
					<tr class="subheading">
						...
						<td width="20%">Notice Type</td>
						<td width="23%">File Name</td>
						<td width="24%">Updated By</td>
						<td width="10%">Updated On</td>
					</tr>
					<s:if test="cercNoticeDetailsList.size()>0">
					<s:iterator value="cercNoticeDetailsList" status="rowstatus">
					<tr class='<s:if test="#rowstatus.even">colored_td</s:if><s:else>white_td</s:else>'>
						...
						<td><s:date name="updatedOn" format="dd/MM/yyyy hh:mm a"/></td>
					</tr>
					</s:iterator>
					</s:if>
