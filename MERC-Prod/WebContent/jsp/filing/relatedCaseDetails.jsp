...
<script type="text/javascript">
	function relatedCaseDetails(){
		alert("test");
		document.relatedCaseDetails.action="searchRelatedCaseSave?struts.token.name=token&token=<s:property value="token"/>";
	...
	function searchRelatedCase(){
		...
		{
			document.relatedCaseDetails.action="searchRelatedCase?struts.token.name=token&token=<s:property value="token"/>";
			document.relatedCaseDetails.submit();
		}
	}
...
<s:form theme="simple" name="relatedCaseDetails" action="searchRelatedCaseSave">
<s:hidden name="filingBeanId"/>
<s:hidden name="cercRelatedPetitionId"/>
	<table border = "0">
		<tr>
			<th colspan="7" class="mainheading">Filing - Add Related Petitions</th>
		</tr>
		...
		<td><s:property value="cercPetitionSearched.subject"/></td>
		...
		<s:submit type="submit" id="searchbutton" value="Cancel" class="formbutton" action="relatedCaseDetailsList"/></td></tr>
		</s:if>
