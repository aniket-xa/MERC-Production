...
<table border = "0">
		<tr>
			<th colspan="7" class="mainheading">Search Petition to Add Deficiencies</th>
		</tr>
		<tr>
			<td colspan="7">
...
<s:form theme="simple" name="deficienciesList">
	<table border = "0">
		<tr>
			<th colspan="7" class="mainheading">Petition to Add Deficiency List</th>
		</tr>
		...
		<tr>
			<td colspan="7">
				<display:table export="false" id="deficiencies" name="deficienciesList" pagesize="20" requestURI="">
						...
						<s:url var="url" action="deficiencyPetitionDetailsFacade">
							<s:param name="struts.token.name">token</s:param>
							<s:param name="token" value="token" />
							<s:param name="pleadingBeanId" value="%{#attr.deficiencies.id}" />
							<s:param name="pleadingsBean.searchBy" value=""/>
						</s:url>
