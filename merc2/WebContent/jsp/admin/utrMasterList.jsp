...
<s:form theme="simple" name="newUserRegistration">
	<table border="0">
		<tr>
			<th colspan="9" class="mainheading">UTR Details for 
			...
			<tr>
				<td colspan="9">
					<display:table export="false" id="utrMaster" name="utrMasterList" pagesize="20" requestURI="">
						<display:column property="utrNumber" title="UTR Number" sortable="true"/>
						<display:column property="amountDeposited" title="Amount (&#8377;)" sortable="true" style="text-align:right" format="{0,number,#,000}"/>
						<display:column property="bankName" title="Bank Name" sortable="true"/>
						<display:column property="branchName" title="Branch" sortable="true"/>
						<display:column property="depositDate" format="{0,date,dd/MM/yyyy}" title="Deposited On" sortable="true"/>
						<display:column property="balanceAmount" title="Balance (&#8377;)" sortable="true" style="text-align:right" format="{0,number,#,000}"/>
						<display:column title="Deposited By" sortable="true">
							(<s:property value="%{#attr.utrMaster.cercUserDepositedBy.userType}"/>)
							<s:property value="%{#attr.utrMaster.cercUserDepositedBy.firstName}"/>
							<s:property value="%{#attr.utrMaster.cercUserDepositedBy.middleName}"/>
							<s:property value="%{#attr.utrMaster.cercUserDepositedBy.lastName}"/>
						</display:column>
