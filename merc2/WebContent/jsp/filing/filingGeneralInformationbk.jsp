...
/*     background: -webkit-gradient(linear,left top,left bottom,color-stop(20%,#fff),color-stop(50%,#fef9f9),color-stop(52%,#eee),to(#f4f4f4)); */
/*     background: linear-gradient(#fff 20%,#f6f6f6 50%,#faf2f2 52%,#f4f4f4 100%); */
...
// 		<!-- 			04-01-2020 end AK -->	
		...
		if ($('select[name="refPetitionType.id"]').val() == "2") 
		{
		...
		function formValidationMulti(e)
		{
			...
			else if ($('select[name="refPetitionType.id"]').val() == "2" && $('#refGenerationTransmissionId').val()=="")
			{
					alert("Please select licensing category");
					$('#refGenerationTransmissionId').focus();
					return false;
			}
			else if($('select[name="refPetitionType.id"]').val() == "2" && $('#tariffPeriodId').val()=="")
				{
...
// 				return false; 
// 			}
		 	else if($('#refActsId').val()!="" && $('#sectionTextbox').val()=="")
			{
			...
			else if(noOfSelectedRegulations < 1 && $('#refActsId').val()=="") 
			{
		...
		$("input[name='nextbutton']").click(formValidationMulti);
	...
	function fidAdd() {
		...
		$('.fidRepeat:first').clone().insertAfter(".fidRepeat:last").find("#RefSectionId").val("");
		var fidLength = $(".fidRepeat").length;
		$( (".fidRepeat") ).each(function(i) {
			if (i < (fidLength-1)) {
				$(".delete").show();
	...
	<table border = "0">
		...
		<tr valign="top">
			...
			<s:if test="filingBeanId==null">
				<s:select name="petitioner.id" list="petitionerList" listKey="id" listValue="firstName+' - '+lastName" headerKey="" headerValue="- Select -" id="refPetitionerOrganisationId" cssStyle="width:142pt" value="#session.CERC_USER.id"/>
			</s:if>
			<s:else>
				<s:select name="petitioner.id" list="petitionerList" listKey="id" listValue="firstName+' - '+lastName" headerKey="" headerValue="- Select -" id="refPetitionerOrganisationId" cssStyle="width:284pt"/>
			...
			<td colspan="5" class="individualPetitioner">
				<input type="text" size="22" name="petitionerName" id="petitionerName"/>
				<s:a action="filingPartyDetails">Details</s:a>
			</td>			
		</tr>
<!-- 		<tr valign="top"> -->
<%-- 			<td colspan = "20">&nbsp;&nbsp;&nbsp;&nbsp;<s:checkbox name="addPetitioner" id="addPetitioner" fieldValue="true"/>Click here if this Petition is being filed on behalf of some other petitioner</td> --%>
<!-- 		</tr> -->
		<tr valign="top">
			<td>Respondent Name (Main)</span></td>
			<td>:</td>
			<td class="organizationPetitioner">
				<s:select class="organizationPetitioner1" name="mainRespondentId"  list="respondentList" listKey="id" listValue="firstName+' - '+lastName" headerKey="0" headerValue="- Select -" id="refPetitionerRespondentId" cssStyle="width:284pt"/>		
		...
		<tr valign = "top" >
			<td colspan = "20">&nbsp;&nbsp;&nbsp;&nbsp;<s:checkbox name="noresp" id="noresp" fieldValue="true" />&nbsp;&nbsp;No Respondents</td>
		</tr>
		<tr class="subheading">
		...
		<tr class="noPetitionSubType">
			...
			<td width="1%">:</td>
			<td width= "28%">
			<s:select list="refPetitionSubTypeList" name="refPetitionSubType.id" id="refPetitionSubTypeId" listKey="id" listValue="petitionSubType" headerKey="" headerValue="- Select -" cssStyle="width:284pt"/>
			</td>
			<td width="2%"></td>
...
<%-- 		<tr>
		...
		<tr valign = "top">
			...
			<td>:</td>
			<!-- 			04-03-2020 start AK -->
			<td colspan="5"><textarea cols="1000" name="briefOfPetition" id = "briefOfPetition" style="width:500pt" ><s:property value="briefOfPetition"/></textarea></td>
			<!-- 			04-03-2020 end AK -->
		...
		<tr>
		<td></td>
			<td colspan = "10"><span class = "tooltip">User may select an act or a regulation but selecting atleast 1 is mandatory</span></td>
		</tr>
		<tr>
			...
			&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
			<span class = "hideRules">Rules</span><span class  = "required" id = "hideRules">*</span>&nbsp;&nbsp;&nbsp;&nbsp;<span class = "hideRules">:</span>&nbsp;&nbsp;&nbsp;&nbsp;
		...
		<tr>
			...
			<s:iterator value="refSectionArray" status="rowstatus">
				<div class="fidRepeat">
					...
					&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;:&nbsp;
					<s:select list="refSectionList" name="refSectionArray" id="RefSectionId" listKey="id" listValue="Section 9" cssStyle="width:142pt;" value="%{refSectionArray[#rowstatus.index]}"/>
<%-- 					<s:select list="refSectionList" name="refSectionArray" id="RefSectionId" listKey="id" listValue="sectionCode" headerKey="" headerValue="- Select -" cssStyle="width:142pt;" value="%{refSectionArray[#rowstatus.index]}"/> --%>
					<s:textfield type="text" size="24" name="section" id = "sectionTextbox" maxlength="160"/>
					&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
					&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
					Sub Section
<!-- 								04-03-2020 start AK -->
...
<%-- 					<s:select list="refSectionList" name="refSectionArray" id="RefSectionId" listKey="id" listValue="sectionCode" headerKey="" headerValue="- Select -" cssStyle="width:142pt;" value="%{refSectionArray[#rowstatus.index]}"/> --%>
		...
		<tr valign="top">
			...
			<td>:</td>
			<td colspan="5" >
			<s:select list="refRegulationList" name="refRegulation" id="refRegulationId" listKey="id" listValue="regulationDescription" headerKey="" headerValue="- Select -" cssStyle="width:510pt" multiple = "true" value="refRegulation"/>
