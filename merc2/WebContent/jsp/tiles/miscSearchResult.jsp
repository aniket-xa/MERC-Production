...
<table border="0">
		<s:if test="searchResultList.size>0">
			<tr>
				<th colspan="8" class="mainheading">Searched Petitions</th>				
			</tr>
			<tr>
			...
			<tr>
				<td colspan="8">
					<display:table export="true" id="searchResult" name="searchResultList" pagesize="20" requestURI="/miscSearchCase.action">
					...
					<display:column title="Disposed of On" sortable="true">
