...
<s:if test="pleadingList.size()>0">
		<tr>
			...
			<s:a id="reportWindow" onclick="reportWindow('/merc/run?__report=pleadingList.rptdesign&petitionId=%{cercPetition.id}&userId=%{#session.CERC_USER.id}&adminId=%{#session.CERC_USER.refOrganisationId.updatedBy.id}');" href="#">
