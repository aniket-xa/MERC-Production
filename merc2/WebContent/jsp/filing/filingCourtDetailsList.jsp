...
<s:form theme="simple" name="filingCourtDetailsList">

	<table border = "0">
		<tr>
			<th colspan="7" class="mainheading">Filing - Court Details List</th>
		</tr>
			...
			<td colspan="7">
				<table border = "0" >
					<tr class="subheading">
						...
						<td width="10%">Type</td>
						<td width="26%">Name</td>
						<td width = "15%">Authority Type</td>
						<td width="20%">Case Number</td>
						<td width="20%">Order Date</td>
						<td width="14%">Interim / Final</td>
					...
					<tr class='<s:if test="#rowstatus.even">colored_td</s:if><s:else>white_td</s:else>'>
						...
						<td><s:property value="refAuthorityType.authorityType"/></td>
