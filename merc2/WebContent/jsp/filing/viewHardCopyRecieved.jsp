...
<s:form theme="simple" name="viewHardCopyRecieved" action="viewHardCopyRecievedDateSave">
	<s:hidden name="filingBeanId1"/>
	<table border = "0">
		<tr>
			<th colspan="7" class="mainheading">Petition Hard Copy Details <s:if test="cercPetition.isMigrated == true"><font color="red"><b>(MIGRATED PETITION)</b></font></s:if></th>
		</tr>
		...
		<tr valign="top">
		<s:if test="#session.CERC_USER.refDivisionId.divisionCode.trim()==12">
			<td>Enter Related Referred Back Petition</td></s:if>
		...
		<tr>
			<td colspan="7" align="right"><s:if test="#session.CERC_USER.refDivisionId.divisionCode.trim()==12"><s:submit id="savebutton"
				...
				<s:submit id="cancelbutton" name="cancelbutton" value="Cancel"
					class="formbutton" action="viewRegisteredPetitionsCount" /></td>
		</tr>
