...
<s:form theme="simple" name="forClarificationRejectionSubmit" id="forClarificationRejectionSubmit" action="forClarificationRejectionSubmit" method="post">
 <s:push value="cercUser"> 
 <s:hidden name="cercUserId" value="%{cercUser.id}"/>
	<table border = "0">
		...
		<s:submit type="submit" id="savebutton" name="savebutton" value="Save" class="formbutton" />&nbsp;&nbsp;
